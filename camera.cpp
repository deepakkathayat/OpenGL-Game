...
void CCamera::Render( void )
{
	...
	//printf("Px=%f Py=%f Pz=%f  Vx=%f Vy=%f Vz=%f  Upx=%f Upy=%f Upz=%f\n",Position.x,Position.y,Position.z,ViewPoint.x,ViewPoint.y,ViewPoint.z,UpVector.x,UpVector.y,UpVector.z);
}
